...
const VerifyMFA = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const API_BASE_URL = process.env.REACT_APP_API_URL || (typeof window !== 'undefined' && window.location.origin.includes('mindify.app') ? window.location.origin : 'https://mindify.app');
